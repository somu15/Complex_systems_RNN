...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 31 20:21:46 2020
...
dataset_path = '/Users/som/Dropbox/Complex_systems_RNN/Data/DL_test_data_Hurr_Hazus_125.csv'
...
def transform(Rec):
    ...
    Rec = np.power((1-Rec),1/4)
    return Rec

def invtransform(x):
    return (1-np.power(x,4))#beta.cdf(x,a1,b1,loc1,sca1)
    # return np.exp(x)
...
# dataset_path2 = '/Users/som/Dropbox/Complex_systems_RNN/Data/DL_verify_EQ_0_9.csv'
...
# dataset_path3 = '/Users/som/Dropbox/Complex_systems_RNN/Data/DL_verify_EQ_1_1.csv'
...
# dataset_path4 = '/Users/som/Dropbox/Complex_systems_RNN/Data/DL_verify_EQ_1_3.csv'
...
# dataset_path5 = '/Users/som/Dropbox/Complex_systems_RNN/Data/DL_verify_EQ_1_5.csv'
...
# dataset_path6 = '/Users/som/Dropbox/Complex_systems_RNN/Data/DL_verify_EQ_1_7.csv'
...
# plt.figure(0)
# a = plt.axes(aspect='equal')
# plt.scatter(invtransform(data1_labels), invtransform(data1_pred))
# plt.scatter(invtransform(data2_labels), invtransform(data2_pred))
# plt.scatter(invtransform(data3_labels), invtransform(data3_pred))
# plt.scatter(invtransform(data4_labels), invtransform(data4_pred))
# plt.scatter(invtransform(data5_labels), invtransform(data5_pred))
# plt.scatter(invtransform(data6_labels), invtransform(data6_pred))
# plt.xlabel('True Values [Rec]')
# plt.ylabel('Predictions [Rec]')
# lims = [0, 1]
# plt.xlim(lims)
...
# CORR1 = 1/6 * (np.corrcoef(invtransform(data1_labels), invtransform(data1_pred))+np.corrcoef(invtransform(data2_labels), invtransform(data2_pred))+np.corrcoef(invtransform(data3_labels), invtransform(data3_pred))+np.corrcoef(invtransform(data4_labels), invtransform(data4_pred))+np.corrcoef(invtransform(data5_labels), invtransform(data5_pred))+np.corrcoef(invtransform(data6_labels), invtransform(data6_pred)))

# ERR1 = 1/6 * (np.sum(np.abs(invtransform(data1_labels)-invtransform(data1_pred)))+np.sum(np.abs(invtransform(data2_labels)-invtransform(data2_pred)))+np.sum(np.abs(invtransform(data3_labels)-invtransform(data3_pred)))+np.sum(np.abs(invtransform(data4_labels)-invtransform(data4_pred)))+np.sum(np.abs(invtransform(data5_labels)-invtransform(data5_pred)))+np.sum(np.abs(invtransform(data6_labels)-invtransform(data6_pred))))

# plt.figure(1)
# plt.plot(data1['Time'],invtransform(data1_labels))
# plt.plot(data1['Time'],invtransform(data1_pred))
# plt.plot(data2['Time'],invtransform(data2_labels))
# plt.plot(data2['Time'],invtransform(data2_pred))
# plt.plot(data3['Time'],invtransform(data3_labels))
# plt.plot(data3['Time'],invtransform(data3_pred))
# plt.plot(data4['Time'],invtransform(data4_labels))
# plt.plot(data4['Time'],invtransform(data4_pred))
# plt.plot(data5['Time'],invtransform(data5_labels))
# plt.plot(data5['Time'],invtransform(data5_pred))
# plt.plot(data6['Time'],invtransform(data6_labels))
# plt.plot(data6['Time'],invtransform(data6_pred))
# plt.xlabel('Time [days]')
# plt.ylabel('Functionality')
# plt.xlim([0, 800])
# plt.ylim([0, 1])
...
dat_haz = '/Users/som/Dropbox/Complex_systems_RNN/Data/Hurr_DiffHaz.csv'
...
Disf_comp = pd.read_csv('/Users/som/Dropbox/Complex_systems_RNN/Data/Hurr_Disf_Exact.csv')
...
plt.figure(2)
plt.loglog(Tim,Disf,Disf_comp['Time'],Disf_comp['Disf'])
plt.xlim([10,1000])
