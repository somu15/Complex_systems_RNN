...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep  5 15:49:55 2020
...
dataset_path11 = '/Users/som/Dropbox/Complex_systems_RNN/Data/DL_verify_EQ_1_7.csv'
data11 = pd.read_csv(dataset_path11)
...
# plt.figure(4)
# plt.plot(data11['Time'],invtransform(data1_labels))
# plt.plot(data11['Time'],invtransform(data1_pred))
# plt.plot(data11['Time'],invtransform(data2_labels))
# plt.plot(data11['Time'],invtransform(data2_pred))
# plt.plot(data11['Time'],invtransform(data3_labels))
# plt.plot(data11['Time'],invtransform(data3_pred))
# plt.plot(data11['Time'],invtransform(data4_labels))
# plt.plot(data11['Time'],invtransform(data4_pred))
# plt.plot(data11['Time'],invtransform(data5_labels))
# plt.plot(data11['Time'],invtransform(data5_pred))
# plt.plot(data11['Time'],invtransform(data6_labels),label='Exact')
# plt.plot(data11['Time'],invtransform(data6_pred),label='DNN')
# plt.xlabel('Time [days]')
# plt.ylabel('Functionality')
# plt.xlim([0, 800])
# plt.ylim([0, 1])
...
plt.plot(IMe[0:199],Res[0:199,200],IMe[0:199],DisfFrag_exact[0:199,200])
plt.ylim([0.0,0.5])
...
for ii in np.arange(0,len(Tim),1):
    ...
    Disf[ii] = np.trapz(dat_haz['Haz_diff'][0:199]*Res[0:199,ii],IMe[0:199])
    Disf_exact[ii] = np.trapz(dat_haz['Haz_diff'][0:199]*DisfFrag_exact[0:199,ii],IMe[0:199])
    if ii>9:
